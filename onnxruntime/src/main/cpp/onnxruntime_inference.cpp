...
Inference::Inference(Ort::Env &env, const char *modelpath, int num_threads, int img_height,
                     int img_width) : env_(env), modelpath_(modelpath),
